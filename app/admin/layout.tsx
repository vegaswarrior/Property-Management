        ...
        <div className='flex flex-1 text-black'>
          ...
          <aside className='hidden md:flex flex-col w-64 border-r border-white/10 glass-effect-dark px-4 py-6 gap-6 tablet-inspection-mode'>
            ...
            {/* <div className='tablet-hidden space-y-2 pt-4 border-t border-white/10'>
              <Link
                ...
                className='btn-modern text-black px-3 py-2 rounded-lg text-sm font-medium tablet-touch-target'
              >
                💰 Cash Collection
              </Link>
            </div> */}
          ...
          <div className='flex-1 flex flex-col'>
            {/* <header className='h-12 md:h-14 border-b border-white/10 glass-effect-dark flex items-center justify-between px-3 md:px-4'>
              <div className='flex items-center gap-2 text-sm md:text-sm text-black'>
                <span className='font-semibold text-black'>Landlord Dashboard</span>
                <span className='hidden sm:inline text-black'>/ Overview</span>
              </div>
            </header> */}
