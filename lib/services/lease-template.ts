...
<html>
  <head>
    ...
    <style>
      ...
      .date-line { border-bottom: 1px solid #333; width: 120px; display: inline-block; padding-left: 5px; }
      .sig-row { margin-top: 25px; display: flex; align-items: flex-end; gap: 20px; flex-wrap: wrap; }
      .sig-label { font-weight: bold; margin-right: 8px; }
      .initials { font-size: 10px; color: #666; margin-top: 8px; }
      .initials-block { 
        display: inline-block; 
        min-width: 70px; 
        border-bottom: 2px solid #333; 
  ...
  <body>
    ...
    <div class="section">
      ...
      <p class="initials"><strong>Tenant Initials:</strong> <span class="initials-block">/init1/</span></p>
    </div>
    ...
    <div class="section">
      ...
      <p class="initials"><strong>Tenant Initials:</strong> <span class="initials-block">/init2/</span></p>
    </div>
    ...
    <div class="section">
      ...
      <p class="initials"><strong>Tenant Initials:</strong> <span class="initials-block">/init3/</span></p>
    </div>

    <h2>Security Deposit</h2>
    <div class="section">
      <p>Tenant shall pay a security deposit as required by law and/or as provided in the addendum(s) to this Lease.</p>
      <p class="initials"><strong>Tenant Initials:</strong> <span class="initials-block">/init4/</span></p>
    </div>
    ...
    <div class="section">
      ...
      <p class="initials"><strong>Tenant Initials:</strong> <span class="initials-block">/init5/</span></p>
    </div>

    <h2>Rules & Regulations</h2>
    <div class="section">
      <p>Tenant agrees to comply with all property rules.</p>
      <p class="initials"><strong>Tenant Initials:</strong> <span class="initials-block">/init6/</span></p>
    </div>
